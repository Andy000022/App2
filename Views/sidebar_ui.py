...
"        color:#fff;}")
        ...
        self.usuario_nombre = QtWidgets.QLabel(self.widget)
        self.usuario_nombre.setText("")
        self.usuario_nombre.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.usuario_nombre.setWordWrap(True)
        self.usuario_nombre.setObjectName("usuario_nombre")
        self.horizontalLayout_4.addWidget(self.usuario_nombre)
        ...
        self.btn_selec = QtWidgets.QPushButton(self.widget_5)
        self.btn_selec.setObjectName("btn_selec")
        self.horizontalLayout_17.addWidget(self.btn_selec)
        ...
        spacerItem38 = QtWidgets.QSpacerItem(20, 178, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        ...
        self.btn_ayuda_2 = QtWidgets.QPushButton(self.full_menu_widget)
        self.btn_ayuda_2.setObjectName("btn_ayuda_2")
        self.verticalLayout_13.addWidget(self.btn_ayuda_2)
        ...
        self.btn_ayuda_1 = QtWidgets.QPushButton(self.icon_only_widget)
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(False)
        self.btn_ayuda_1.setFont(font)
        self.btn_ayuda_1.setStyleSheet("color:#788596;")
        self.btn_ayuda_1.setObjectName("btn_ayuda_1")
        self.verticalLayout_5.addWidget(self.btn_ayuda_1)
        ...
        self.btn_ayuda_2.toggled['bool'].connect(self.btn_ayuda_1.toggle) # type: ignore
        self.btn_ayuda_1.toggled['bool'].connect(self.btn_ayuda_2.toggle) # type: ignore
...
" que hayas vuelto..."))
        ...
        self.label_34.setText(_translate("MainWindow", "Ingrese el codigo:"))
        self.btn_buscar_1.setText(_translate("MainWindow", "Seleccionar"))
        ...
        self.label_35.setText(_translate("MainWindow", "Ingrese el codigo:"))
        self.btn_buscar_2.setText(_translate("MainWindow", "Seleccionar"))
        ...
        self.label_18.setText(_translate("MainWindow", "Ingrese el Codigo:"))
        self.btn_selec.setText(_translate("MainWindow", "Seleccionar"))
        ...
        self.btn_ayuda_2.setText(_translate("MainWindow", "  Ayuda"))
        self.exit_btn_2.setText(_translate("MainWindow", "Salir"))
        self.btn_ayuda_1.setText(_translate("MainWindow", "?"))
